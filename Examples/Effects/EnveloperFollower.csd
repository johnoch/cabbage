<Cabbage>
form caption("Envelope Follower") size(320, 120)
image pos(0, 0), size(300, 100), line(1), colour("brown"), shape("rounded"), outline("white"), line(4) 
rslider bounds(10, 11, 70, 70), text("Sensitivity"), channel("sens"), range(0, 1, 0.65)
rslider bounds(80, 11, 70, 70), text("Frequency"), channel("freq"), range(10, 10000, 1000, 0.5)
rslider bounds(150, 11, 70, 70), text("Resonance"), channel("res"), range(0,  1, 0.75)
