...
image pos(0, 0), size(240, 90), line(1), colour("Chocolate"), shape("rounded"), outline("white"), line(4)
rslider bounds(10,  11, 70, 70), text("Bits"), channel("bits"), range(0, 1, 0)
rslider bounds(80, 11, 70, 70), text("Foldover"), channel("fold"), range(1, 1024, 0, 0.25)
rslider bounds(150, 11, 70, 70), text("Level"), channel("level"), range(0, 1, 1)
}
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
