<Cabbage>
form caption("Phaser") size(460, 100), pluginID("esgs")
rslider bounds(0, 0, 80, 80), caption("Rate"), channel("rate"), range(0, 1, 0.2, .25, 0.001) midiCtrl(1,1)
rslider bounds(90, 0, 80, 80), caption("Depth"), channel("depth"), range(0, 1, 0.5, 1, .01)
rslider bounds(180, 0, 80, 80), caption("Freq."), channel("freq"), range(0, 1, 0.4, 1, .01)
rslider bounds(270, 0, 80, 80), caption("Feedback"), channel("fback"), range(0, 1, 0.4, 1, .01)
rslider bounds(360, 0, 80, 80), caption("Level"), channel("level"), range(0, 1, 1, 1, .01)
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
-d -n
