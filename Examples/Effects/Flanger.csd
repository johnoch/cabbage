<Cabbage>
form caption("Flanger") size(390, 120)
;groupbox bounds(0, 0, 590, 160), text("Flanger"), plant("Flanger"){
image pos(0, 0), size(370, 90), line(1), colour("LightGreen"), shape("rounded"), outline("white"), line(4) 
rslider bounds(10, 10, 70, 70), text("Rate"), channel("rate"), range(0, 1, 0.1)
rslider bounds(80, 10, 70, 70), text("Depth"), channel("depth"), range(0, 1, 0.5)
rslider bounds(150, 10, 70, 70), text("Delay"), channel("delay"), range(0, 1, 0.1)
rslider bounds(220, 10, 70, 70), text("Feedback"), channel("fback"), range(-1, 1, 0.9)
rslider bounds(290, 10, 70, 70), text("Level"), channel("level"), range(0, 1, 1)
}
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
