<Cabbage>
form caption("Drone Instrunment"), size(700, 750), colour("black")
keyboard bounds(10, 650, 660, 80)
...
hslider caption("Number of harmonics per oscillator"), bounds(10, 540, 660, 50), channel("harms"), range(1, 100, 10), colour("white") 
hslider caption("Harmonic attenuation"), bounds(10, 590, 660, 50), channel("atten"), range(0, 1, 0.5), colour("white") 
...
rslider bounds(10, 210, 100, 100), caption("Dist."), channel("dist"), colour("black"), range(0, 10, 0)
}
...
aoscA gbuzz kAvol*((0.50 + ktremA*kAtremSwitch)*0dbfs), (kAcoarse+kAfine)+p4, knh, 0, katten, 1
...
aoscB gbuzz kBvol*((0.50 + ktremB*kBtremSwitch)*0dbfs), (kBcoarse+kBfine)+p4, knh, 0, katten, 1
...
aoscC gbuzz kCvol*((0.50 + ktremC*kCtremSwitch)*0dbfs), (kCcoarse+kCfine)+p4, knh, 0, katten, 1
...
aoscD gbuzz kDvol*((0.50 + ktremD*kDtremSwitch)*0dbfs), (kDcoarse+kDfine)+p4, knh, 0, katten, 1
