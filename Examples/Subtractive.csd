...
image pos(0, 0), size(450, 130), colour("black"), shape("rounded"), outline("white"), line(4)
rslider pos(30, 20), size(90, 90) channel("cf"), min(0), max(20000), value(1000), caption("Centre Frequency"), colour("white"), midictrl(1, 7)
rslider pos(130, 20), size(90, 90) channel("res"), min(0), max(1), value(0.5), caption("Resonance"), colour("white"), midictrl(2, 7)
