<Cabbage>
form caption("Wave Terrain Synth"), size(780, 310), pluginID("wte1") 
...
rslider bounds(15, 30, 60, 60), text("A"), colour("red"), channel("att"), range(0.01,3, .5)
rslider bounds(65, 30, 60, 60), text("D"), colour("red"), channel("dec"), range(0,1, .5)
rslider bounds(115, 30, 60, 60), text("S"), colour("red"), channel("sus"), range(0,1,.8)
rslider bounds(165, 30, 60, 60), text("R"), colour("red"), channel("rel"), range(0.01,3, .2)
}

groupbox bounds(260, 105, 240, 100), text("Tune/Moog filter"), plant("tune"){ 
rslider bounds(15, 30, 60, 60), text("Coarse"), colour("red"), channel("det1"), range(-24,12,0)
rslider bounds(65, 30, 60, 60), text("Detune"), colour("red"), channel("detune"), range(-1,1,0)
rslider bounds(115, 30, 60, 60), text("cutoff"), colour("red"), channel("cutoff"), range(500,22000,4000)
rslider bounds(165, 30, 60, 60), text("reso"), colour("red"), channel("resonance"), range(.1,.9,.5)
}

groupbox bounds(510,0, 240, 100), text("LFO/Stereo chorus"), plant("mod"){ 
rslider bounds(15, 30, 60, 60), text("Lfo amp"), colour("red"), channel("lfoamp"), range(0,50, 0)
rslider bounds(65, 30, 60, 60), text("Lfo rate"), colour("red"), channel("lforate"), range(0,20, 0)
rslider bounds(115, 30, 60, 60), text("depth"), colour("red"), channel("chdepth"), range(0,10,0)
rslider bounds(165, 30, 60, 60), text("rate"), colour("red"), channel("chrate"), range(0,10,0)
}

groupbox bounds(510,105, 240, 100), text("Reverb"), plant("rev"){ 
rslider bounds(15, 30, 60, 60), text("level"), colour("red"), channel("level"), range(0,1,0)
rslider bounds(65, 30, 60, 60), text("size"), colour("red"), channel("size"), range(.1,.99,.5)
;rslider bounds(115, 30, 60, 60), text("depth"), colour("red"), channel("chdepth"), range(0,10,0)
;rslider bounds(165, 30, 60, 60), text("rate"), colour("red"), channel("chrate"), range(0,10,0)
