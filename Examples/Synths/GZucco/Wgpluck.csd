<Cabbage>
form caption("Waveguide pluck ") size(355, 150), colour("black"), pluginID("plu1")
rslider pos(0, 0), size(80, 80) channel("pick"), range(.1, 1,.5), caption("Pick"), colour("yellow"), midictrl(1, 1)
