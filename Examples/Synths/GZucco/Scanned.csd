<Cabbage>
form caption("Scanned synthesizer") size(572, 320), colour("black"),pluginID("sca1") 
...
rslider bounds(15, 30, 60, 60), text("A"), colour("orange"), channel("att"), range(0.01,3, .5)
rslider bounds(65, 30, 60, 60), text("D"), colour("orange"), channel("dec"), range(0,1, .5)
...
rslider bounds(15, 30, 60, 60), text("Lfo Amp"), colour("orange"), channel("lfoamp"), range(0,4, 0)
rslider bounds(65, 30, 60, 60), text("Lfo Rate"), colour("orange"), channel("lforate"), range(.1,10, 0)
;rslider bounds(115, 30, 60, 60), text("S"), colour("orange"), channel("sus"), range(0,1,.8)
;rslider bounds(165, 30, 60, 60), text("R"), colour("orange"), channel("rel"), range(0.01,3, .2)
}
groupbox bounds(410, 120, 130, 100), text("LFO filter"), plant("lfofilter"){ 
rslider bounds(15, 30, 60, 60), text("Lfo Amp"), colour("orange"), channel("lfoamp2"), range(0,1000, 0)
...
scanu	1,.01+i(krate),ifnvel,ifnmass,ifnstif,ifnctr,ifndamp,kmass,kstif, \
