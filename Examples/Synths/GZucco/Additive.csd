...
rslider bounds(15, 30, 60, 60), text("A"), colour("lime "), channel("att"), range(0.01,3, .5)
rslider bounds(65, 30, 60, 60), text("D"), colour("lime "), channel("dec"), range(0,1, .5)
rslider bounds(115, 30, 60, 60), text("S"), colour("lime "), channel("sus"), range(0,1,.8)
rslider bounds(165, 30, 60, 60), text("R"), colour("lime "), channel("rel"), range(0.01,3, .2)
}
groupbox bounds(285, 120, 250, 100), text("Filter/Reverb"), plant("filtrev"){ 
rslider bounds(15, 30, 60, 60), text("cutoff"), colour("lime "), channel("cutoff"), range(200,8000,1000)
rslider bounds(65, 30, 60, 60),text("level"), colour("lime "), channel("level"), range(0,1,.7)
rslider bounds(115, 30, 60, 60), text("size"), colour("lime "), channel("size"), range(.1,.99,.8)
checkbox  bounds(170, 30, 160, 30),channel("onoff"), text("ON"), value(0)
}
