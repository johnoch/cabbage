<Cabbage>
form caption("HiperSaw synthesizer") size(572, 320), colour("black"),pluginID("hip1") 
...
rslider bounds(15, 30, 60, 60), text("Lfo Amp"), colour("orange"), channel("lfoamp"), range(0,100, 0)
