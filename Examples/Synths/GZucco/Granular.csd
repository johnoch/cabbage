<Cabbage>
form caption("Granular synthesizer") size(440, 200), colour("black"), pluginID("gra1")
...
combobox bounds(0, 90, 160, 20), channel("func1"), value(14), text("wt1","wt2","wt3","wt4","wt5","wt6","wt7","wt8","wt9","wt10","wt11","wt12","wt13","wt14")
combobox bounds(220, 90, 160, 20), channel("func2"), value(5), text("wt1","wt2","wt3","wt4","wt5","wt6","wt7","wt8","wt9","wt10","wt11","wt12","wt13","wt14")
