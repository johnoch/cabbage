<Cabbage>
form caption("Oscillator Bank Synth") size(485, 285)
...
groupbox bounds(0, 85, 485, 85), text("Filter"){
rslider bounds( 15, 110, 55, 55), fontcolour("white"), text("Filter"), channel("cf"), range(0, 10, 2), tracker("white")
rslider bounds( 60, 110, 55, 55), fontcolour("white"), text("Res."), channel("res"), range(0, 0.99, 0,0.5), tracker("white")
rslider bounds(105, 110, 55, 55), fontcolour("white"), text("Env."), channel("FEnvAmt"), range(0, 1, 1), tracker("white")
rslider bounds(150, 110, 55, 55), fontcolour("white"), text("L1."), channel("FL1"), range(0, 10, 0), tracker("white")
rslider bounds(195, 110, 55, 55), fontcolour("white"), text("Att."), channel("FAtt"), range(0, 8, 0.95,0.5), tracker("white")
rslider bounds(240, 110, 55, 55), fontcolour("white"), text("L2."), channel("FL2"), range(0, 10, 6), tracker("white")
rslider bounds(285, 110, 55, 55), fontcolour("white"), text("Dec."), channel("FDec"), range(0, 8, 1.83,0.5), tracker("white")
rslider bounds(330, 110, 55, 55), fontcolour("white"), text("Sus."), channel("FSus"), range(0, 10, 4, 0.5), tracker("white")
rslider bounds(375, 110, 55, 55), fontcolour("white"), text("Rel."), channel("FRel"), range(0.01, 8, 1.3, 0.5), tracker("white")
rslider bounds(420, 110, 55, 55), fontcolour("white"), text("Rel.Lev."), channel("FRLev"), range(0, 10, 0), tracker("white")
}

keyboard bounds(0, 175, 480, 75)

image bounds(5, 258, 250, 25), colour(75, 85, 90, 100), plant("credit"){
...
instr	2
	...
	kporttime	=	kporttime*kLegTim	;scale portamento time function with value from GUI knob widget
	...
	aL	moogvcf2	aL,kCF,kres			;USE 'moogvcf2' IF YOU NEED TO CONSERVE CPU RESOURCES
	aR	moogvcf2	aR,kCF,kres
