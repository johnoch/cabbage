      ...
      isGeneric (isGeneric_)
{
	...
	//this->setLookAndFeel(&this->getParentComponent()->getLookAndFeel());
...
//called each time we drop a new plugin onto our graph editor panel
