<Cabbage>
form caption("Cabbage Formant Synth"), size(520, 310), pluginID("FOF9")
...
rslider bounds(15, 30, 60, 60), text("Amp"), colour("red"), channel("amp1"), range(0, .5, .5)
rslider bounds(65, 30, 60, 60), text("BW"), colour("red"), channel("bw1"), range(10, 120, 60)
rslider bounds(115, 30, 60, 60), text("Rise"), colour("red"), channel("rise1"), range(0.001, 0.01, 0.001)
rslider bounds(165, 30, 60, 60), text("Decay"), colour("red"), channel("dec1"), range(0.001, 0.01, 0.001)
}
